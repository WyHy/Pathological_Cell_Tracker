...
lib = CDLL(cfg.darknet.dartnetlib, RTLD_GLOBAL)
...
if __name__ == "__main__":
    ...
    path = "./dog.jpg"
    net = load_net(b"./yolov3-minitest-infer.cfg", b"../../dataset_files/yolov3-sota.weights", 0)
    meta = load_meta(b"./minitest.data")
